...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $goods_id = $is_insert ? $db->insert_id() : $_REQUEST['goods_id'];
		...
		$sql = "UPDATE " . $ecs->table('goods') . " SET " .
                "chanpinchicun = '$_POST[chanpinchicun]', " .
                "chanpincaizhi = '$_POST[chanpincaizhi]', " .
								"baozhuangfangshi = '$_POST[baozhuangfangshi]', " .
								"zhuangxiangshuliang = '$_POST[zhuangxiangshuliang]', " .
								"zuixiaoqidingliang = '$_POST[zuixiaoqidingliang]', " .
								"gongqi = '$_POST[gongqi]', " .
								"gongchangmingcheng = '$_POST[gongchangmingcheng]', " .
								"caigouyuan = '$_POST[caigouyuan]', " .
								"qita = '$_POST[qita]' " .
